...
$tor_options_description = array (
		...
		(Default: 0)</p>',
		'ognized' => '<p class="tor_option_description">Recognized
		flags are</p><p class="tor_option_description_indented"><b>GroupWritable</b></p><p class="tor_option_description_indented2">Unix domain sockets only: makes
		...
		the socket get created as world−writable.</p>',
		...
		'Log' => '<p class="tor_option_description"><b>Log
		[</b><i>domain</i>,...<b>]</b><i>minSeverity</i>[−<i>maxSeverity</i>]
		... <b>stderr</b>|<b>stdout</b>|<b>syslog</b></p><p class="tor_option_description_indented">As above, but select messages
		...
		of them prefixed by a comma−separated list of logging
		...
		matches all domains.</p><p class="tor_option_description_indented">This is an
		advanced feature which is most useful for debugging one or
		two of Tor’s subsystems at a time.</p><p class="tor_option_description_indented">The currently
		...
		are case−insensitive.</p><p class="tor_option_description_indented">For example,
		"Log [handshake]debug [~net,~mm]info notice
		stdout" sends to stdout: all handshake messages of any
		severity, all info−and−higher messages from
